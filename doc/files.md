...
* bitcoin.conf: contains configuration settings for microd or micro-qt
* microd.pid: stores the process id of microd while running
...
* debug.log: contains debug information and general logging generated by microd or micro-qt
