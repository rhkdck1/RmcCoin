...
BITCOINCLI=${BITCOINCLI:-$BINDIR/micro-cli}
BITCOINTX=${BITCOINTX:-$BINDIR/micro-tx}
BITCOINQT=${BITCOINQT:-$BINDIR/qt/micro-qt}
...
for cmd in $MICROD $BITCOINCLI $BITCOINTX $BITCOINQT; do
  cmdname="${cmd##*/}"
